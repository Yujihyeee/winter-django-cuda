...
export declare const RadarDots: <D extends Record<string, unknown>>({ data, keys, getIndex, colorByKey, radiusScale, angleStep, symbol, size, color, borderWidth, borderColor, enableLabel, label, formatValue, labelYOffset, }: RadarDotsProps<D>) => JSX.Element;
export {};
