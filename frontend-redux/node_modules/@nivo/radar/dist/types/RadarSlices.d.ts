...
export declare const RadarSlices: <D extends Record<string, unknown>>({ data, keys, getIndex, formatValue, colorByKey, radius, angleStep, tooltip, }: RadarSlicesProps<D>) => JSX.Element;
export {};
